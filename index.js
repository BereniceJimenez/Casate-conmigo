...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = '¡Ya sabia que si querias corazón de melón! jajaja';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 1:
            ...
            document.getElementById('noBtn').innerHTML = '¡¿Entonces no me amas?!';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('sadGifContainer').style.display = 'none';
        ...
        case 2:
            ...
            document.getElementById('noBtn').innerHTML = 'No quieres que compremos otro chiwis cafecito?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('sadGifContainer').style.display = 'none';
            document.getElementById('sadGifContainer2').style.display = 'none';
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = '¿Entonces no?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 4:
            ...
            document.getElementById('noBtn').innerHTML = 'Si dices que si te doy un premio el sabado';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
...
document.getElementById('noBtn').innerHTML = 'Si, dices que no me voy a enojar';
document.getElementById('noBtn').style.backgroundColor = '#F1330A';
...
document.getElementById('noBtn').innerHTML = '¿Quieres que me enoje?';
document.getElementById('noBtn').style.backgroundColor = '#F1330A';
...
document.getElementById('siBtn').style.fontSize = '120px';
        ...
        case 8:
            ...
            document.getElementById('noBtn').innerHTML = 'Te vas a aguantaaaar';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 9:
            ...
            document.getElementById('noBtn').innerHTML = 'Ya mejor dime que no me amas';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 10:
            ...
            document.getElementById('noBtn').innerHTML = 'Entonces no te gustan las chichiwas jaja';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 11:
            ...
            document.getElementById('noBtn').innerHTML = 'Ya dimeee que siiii';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 12:
            ...
            document.getElementById('noBtn').innerHTML = 'Di que si amorcito';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 13:
            document.getElementById('noBtn').innerHTML = 'Si dices que no no te gustan los chiwis :(';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 14:
            ...
            document.getElementById('noBtn').innerHTML = 'Te pago para que digas que si';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 15:
            ...
            document.getElementById('noBtn').innerHTML = 'Te pico la cola si dices que si';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 16:
                document.getElementById('noBtn').innerHTML = 'Por favor corazón de melón';
                document.getElementById('noBtn').style.backgroundColor = '#F1330A';
